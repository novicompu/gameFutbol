function CGame(oData) {
    ...
    let urlLog;
    let payjoy = 'canchapayjoy.novicompu.com';
    let epson = 'epson.novicompu.com';
    let honor = 'honor.novicompu.com';
    let pacifico = 'pacifico.novicompu.com';
    let urlSave = honor;
...
/*
    ...
    this.onExit = function () {
        ...
        s_oMain.gotoMenu(); // Asegúrate de que esta función muestra la interfaz de "game over"
    };
    ...
    this.restartGame = function () {
        ...
        //var currentPaths = new URL(window.location.href).host;
        var currentPath = 'pacifico.novicompu.com';
        ...
        if (currentPath === (pacifico || honor || epson)) {
            urlLog = 'submit-loginMarcas';
            //urlLog = 'submit-login';
        } else if (currentPath === payjoy) {
            urlLog = 'submit-login';
        }
        ...
        .then(data => {
            ...
            if (data.error) {
                ...
                this.resetValues();  // Aquí se reinician los valores, incluido el puntaje
                this.resetScene();
                this.resetTimer();
                this.startTimer();
    ...
    this.gameOver = function () {
        ...
        var oButScoresBg = new createjs.Shape();
        oButScoresBg.graphics.beginFill("#0000FF").drawRoundRect(0, 0, 300, 60, 10);
        oButScoresBg.x = CANVAS_WIDTH * 0.5 - 150;
        ...
        oGroup.addChild(oButScoresText);
    
        oButScoresBg.addEventListener("click", function () {
            showBestScores();
        });
    
        var oSpriteButRestart = s_oSpriteLibrary.getSprite("but_restart");
        var oButRestart = new CGfxButton(CANVAS_WIDTH * 0.5, oButScoresBg.y + 100, oSpriteButRestart, oGroup);
    ...
    function showBestScores() {
        ...
        //const marca = 'honor.novicompu.com';
        fetch(`${_url}/get-best-scores`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
